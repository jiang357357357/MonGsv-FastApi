    ...
    def _service_payload(self) -> dict[str, Any]:
        ...
        return {
            ...
            "endpoints": [
                ...
                {"name": "transcribe_voiceprint", "protocol": "http", "host": self.config.register_host, "port": self.config.register_port, "path": "/inference/transcribe/voiceprint"},
            ],
            "capabilities": [
                "http_api",
                "tts",
